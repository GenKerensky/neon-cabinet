...
File Locations:
  Models:  ../../battle-tanks/src/models/<category>/<name>.ts
  OBJ:     ../../battle-tanks/src/models/<category>/<name>.obj

For more information, see: ../../battle-tanks/src/models/MODELS.md
`);
}
