...
export class HUD {
  ...
  // Bottom left - Armor
  private armorGraphics!: GameObjects.Graphics;
  private armorLabel!: GameObjects.Text;

  // Cracked windshield effect
  private crackedGraphics!: GameObjects.Graphics;
  private isCracked = false;

  // Bottom center - Radar
  private radarGraphics!: GameObjects.Graphics;

  // Bottom right - Ammo and reload
  private ammoText!: GameObjects.Text;
  private reloadText!: GameObjects.Text;
  private reloadBar!: GameObjects.Graphics;

  // Bottom right - Weapon indicator (above ammo)
  private weaponLabel!: GameObjects.Text;
