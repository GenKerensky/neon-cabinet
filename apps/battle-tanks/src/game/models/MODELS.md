...
- **TypeScript models**: `src/game/models/<category>/<name>.ts`
- **OBJ exports**: `src/game/models/<category>/<name>.obj`
...
This creates `src/game/models/weapons/projectile.obj`
...
2. Navigate to `src/game/models/<category>/`
...
2. **Export**:
   ...
   # Save to: src/game/models/<category>/new-model.obj
   ```
