...
export class Game extends Scene {
  ...
  create(): void {
    ...
    // Manual reload on R
    this.input.keyboard?.addKey(Input.Keyboard.KeyCodes.R).on("down", () => {
      if (this.gameState === "playing") {
    ...
    this.input.keyboard?.addKey(Input.Keyboard.KeyCodes.Q).on("down", () => {
      if (this.gameState === "playing") {
        this.tank.cycleWeaponPrev();
      }
    });

    this.input.keyboard?.addKey(Input.Keyboard.KeyCodes.E).on("down", () => {
      if (this.gameState === "playing") {
    ...
    // Cheat mode on C key
    this.input.keyboard?.addKey(Input.Keyboard.KeyCodes.C).on("down", () => {
